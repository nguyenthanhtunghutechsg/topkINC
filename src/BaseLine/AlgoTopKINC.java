...
public class AlgoTopKINC {
	...
	Map<Integer, Map<Integer, Long>> mapEUCS;
	...
	public void runAlgorithm(String input, String output, int k, int firstLine, int lastLine) throws IOException {
		// reset maximum
		...
		try {
			...
			while ((thisLine = myInput.readLine()) != null && tid < lastLine) {
				...
				if (tid >= firstLine) {
					...
					Long transactionUtility = Long.parseLong(split[1]);
...
//		writer.newLine();
	...
	public void printStats() throws IOException {
		System.out.println("=============  BASELINE TOP-K InCre ALGORITHM - SPMF 0.97e - STATS =============");
		System.out.println(" Total time ~ " + (endTimestamp - startTimestamp) + " ms");
		System.out.println(" Memory ~ " + MemoryLogger.getInstance().getMaxMemory() + " MB");
		System.out.println(" minU : " + min_utility);
		System.out.println(" First minU : " + firstMinU);
